...
from ai_karen_engine.auth import (  # Data models; Configuration; Exceptions
    AuthConfig,
    AuthError,
    AuthEvent,
    AuthEventType,
...
def test_configuration_system():
    ...
    config = AuthConfig(auth_mode=AuthMode.ENHANCED, debug=True)
...
def test_additional_models():
    ...
    # Test SecurityResult
    security_result = SecurityResult(allowed=True, risk_score=0.3)
    ...
    intel_result = IntelligenceResult(
        risk_score=0.7, confidence=0.9, anomaly_detected=True
    )
