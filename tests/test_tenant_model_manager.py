...
def test_tenant_create_and_delete(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("ai_karen_engine.core.model_manager.LICENSE_PATH", license_file)
...
def test_license_enforced(tmp_path: Path, monkeypatch) -> None:
    monkeypatch.setattr("ai_karen_engine.core.model_manager.LICENSE_PATH", tmp_path / "missing.json")
