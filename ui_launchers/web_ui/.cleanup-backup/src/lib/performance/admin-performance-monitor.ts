...
export class AdminPerformanceMonitor {
  ...
  startMonitoring(options: {
    ...
    this.reportInterval = setInterval(() => {
      ...
      if (enableConsoleReports) {
        ...
        console.log('Database queries:', report.database);
        console.log('API requests:', report.api);
        console.log('Component renders:', report.components);
    ...
    console.log('🚀 Admin performance monitoring started');
  }
  ...
  stopMonitoring(): void {
    ...
    console.log('🛑 Admin performance monitoring stopped');
  }
  ...
  private async sendReportToRemote(report: PerformanceReport): Promise<void> {
    try {
      ...
      console.warn('Failed to send performance report to remote service:', error);
    }
  }
