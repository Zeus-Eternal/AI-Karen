...
export function suppressExtensionErrorLogs() {
  ...
  console.info('[EXTENSION-LOG-SUPPRESSION] Extension error log suppression applied');
}
...
export function suppressConsoleExtensionErrors() {
  ...
  console.info('[EXTENSION-CONSOLE-SUPPRESSION] Extension console error suppression applied');
}
...
export function initializeExtensionErrorSuppression() {
  ...
  console.info('[EXTENSION-ERROR-SUPPRESSION] Extension error suppression initialized');
}
