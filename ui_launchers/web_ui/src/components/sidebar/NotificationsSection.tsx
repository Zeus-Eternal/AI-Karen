  ...
  return (
    <div className="p-4 border rounded-lg bg-card text-card-foreground shadow-sm space-y-3">
      ...
      {suggestedFacts.length === 0 ? (
        <p className="text-sm text-muted-foreground">No new facts suggested by Karen recently.</p>
      ) : (
        <>
          <Alert variant="default" className="bg-primary/5 border-primary/20">
            <MessageSquarePlus className="h-4 w-4 !text-primary/80" />
            <AlertTitle className="text-sm font-semibold text-primary">Review Karen's Suggestions</AlertTitle>
          ...
          <ul className="list-disc list-inside pl-2 space-y-1 text-sm text-muted-foreground max-h-60 overflow-y-auto border p-3 rounded-md bg-muted/20">
