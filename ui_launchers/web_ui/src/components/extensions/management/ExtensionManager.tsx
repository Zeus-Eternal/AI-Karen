  ...
  const handleFileUpload = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file && onInstallFromFile) {
      try {
        ...
        console.error('Failed to install extension from file:', error);
      }
    }
    // Reset file input
    event.target.value = '';
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-blue-700">Choose an action to apply to all selected extensions</p>
              </div>
              <div className="flex gap-2">
                <Button
                  size="sm"
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-sm text-gray-500">ID: {extension.id}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <CardContent className="pt-0">
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">{extension.health.message}</p>
                  <p className="text-xs text-gray-500">
