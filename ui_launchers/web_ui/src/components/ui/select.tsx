...
>(({ className, children, ...props }, ref) => (
  <selectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background -muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [& aria-label="Select option">span]:line-clamp-1",
      className
    )}
    {...props}
  >
