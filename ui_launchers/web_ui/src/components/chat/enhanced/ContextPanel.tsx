  ...
  const renderMemoryItem = (memory: MemoryReference) => (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground sm:text-sm md:text-base">
        ...
        {memory.source && (
          <span className="flex items-center gap-1">
            <BookOpen className="h-3 w-3 sm:w-auto md:w-full" />
            {memory.source}
          </span>
        )}
      </div>
  ...
  const renderSuggestionItem = (suggestion: ContextSuggestion) => (
    ...
    >
      <div className="flex items-start gap-2 w-full">
        <Lightbulb className="h-4 w-4 mt-0.5 flex-shrink-0 sm:w-auto md:w-full" />
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
          <TabsList className="grid w-full grid-cols-4 mx-4">
            <TabsTrigger value="threads" className="text-xs sm:text-sm md:text-base">
              <MessageSquare className="h-3 w-3 mr-1 sm:w-auto md:w-full" />
              Threads
            </TabsTrigger>
            ...
            <TabsTrigger value="suggestions" className="text-xs sm:text-sm md:text-base">
              <Lightbulb className="h-3 w-3 mr-1 sm:w-auto md:w-full" />
              Ideas
            </TabsTrigger>
            <TabsTrigger value="patterns" className="text-xs sm:text-sm md:text-base">
              <Users className="h-3 w-3 mr-1 sm:w-auto md:w-full" />
              Patterns
            </TabsTrigger>
          </TabsList>
              ...
              <ScrollArea className="h-full px-4">
                <div className="space-y-3 pb-4">
                  ...
                  {filteredMemories.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                      <Brain className="h-8 w-8 mx-auto mb-2 opacity-50 sm:w-auto md:w-full" />
              ...
              <ScrollArea className="h-full px-4">
                <div className="space-y-3 pb-4">
                  ...
                  {topSuggestions.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                      <Lightbulb className="h-8 w-8 mx-auto mb-2 opacity-50 sm:w-auto md:w-full" />
