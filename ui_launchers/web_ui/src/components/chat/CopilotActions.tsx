...
// Temporary stub for build - original backed up as CopilotActions.tsx.build-backup
export default function CopilotActions() {
  return (
    <div>
      <h2>CopilotActions</h2>
...
export const ChatInterface = CopilotActions;
export const AdaptiveChatInterface = CopilotActions;
