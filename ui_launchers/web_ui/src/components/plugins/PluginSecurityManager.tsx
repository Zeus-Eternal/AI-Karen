        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm">Trusted Domains</span>
                <span className="text-sm font-medium">{securityPolicy.trustedDomains.length}</span>
              </div>
            </div>
          </div>
        </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="none">None - Full system access</SelectItem>
                      <SelectItem value="basic">Basic - Limited access</SelectItem>
                      <SelectItem value="strict">Strict - Sandboxed execution</SelectItem>
                      <SelectItem value="maximum">Maximum - Minimal privileges</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    disabled={readOnly}
                  />
                  <Button onClick={addTrustedDomain} disabled={readOnly}>
                    Add
                  </Button>
                </div>
