      ...
      case 'role_change':
        return (
          <div className="space-y-4">
            <div>
              <label htmlFor="new_role" className="block text-sm font-medium text-gray-700 mb-1">
                New Role
              </label>
              <select
                id="new_role"
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <input
                ...
                disabled={loading}
              />
              <label htmlFor="confirm_delete" className="ml-2 block text-sm text-gray-900">
          ...
          <div className="space-y-2">
            {operations.map((op) => (
              <div key={op.id} className="flex items-center">
                ...
                />
                <label htmlFor={op.id} className="ml-2 block text-sm text-gray-900">
