      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">User Registrations</h3>
            <p className="text-3xl font-bold text-green-600">{activitySummary.user_registrations}</p>
            <p className="text-sm text-gray-600 mt-1">This {activitySummary.period}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Admin Actions</h3>
            <p className="text-3xl font-bold text-blue-600">{activitySummary.admin_actions}</p>
            <p className="text-sm text-gray-600 mt-1">Administrative operations</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-600 mt-1">Authentication success</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-600 mt-1">Authentication failures</p>
          </div>
        </div>
            ...
            <div className="space-y-3">
              {activitySummary.top_users.map((user, index) => (
                <div key={index} className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-600">{user.action_count} actions</span>
                </div>
              ))}
            </div>
          </div>
