      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 md:text-base lg:text-lg"
           aria-label="Button">
            <svg className="h-4 w-4 mr-2 sm:w-auto md:w-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showAdvanced && (
        <div className="border-t border-gray-200 pt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) = aria-label="Select option"> handleFilterChange('role', e.target.value || undefined)}
            ...
            <div>
              <label htmlFor="is_active" className="block text-sm font-medium text-gray-700 mb-1 md:text-base lg:text-lg">
                Status
              </label>
              <select
                id="is_active"
                value={localFilters.is_active === undefined ? '' : localFilters.is_active.toString()}
                onChange={(e) = aria-label="Select option"> handleFilterChange('is_active', e.target.value === '' ? undefined : e.target.value === 'true')}
                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              >
            ...
            <div>
              <label htmlFor="is_verified" className="block text-sm font-medium text-gray-700 mb-1 md:text-base lg:text-lg">
                Verification
              </label>
              <select
                id="is_verified"
                value={localFilters.is_verified === undefined ? '' : localFilters.is_verified.toString()}
                onChange={(e) = aria-label="Select option"> handleFilterChange('is_verified', e.target.value === '' ? undefined : e.target.value === 'true')}
                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            {/* Created Date Range */}
            <div>
              <label htmlFor="created_after" className="block text-sm font-medium text-gray-700 mb-1 md:text-base lg:text-lg">
                Created After
              </label>
              <input
                id="created_after"
                ...
                onChange={(e) = aria-label="Input"> handleFilterChange('created_after', parseDateFromInput(e.target.value))}
                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
            </div>

            <div>
              <label htmlFor="created_before" className="block text-sm font-medium text-gray-700 mb-1 md:text-base lg:text-lg">
                Created Before
              </label>
              <input
                id="created_before"
                ...
                onChange={(e) = aria-label="Input"> handleFilterChange('created_before', parseDateFromInput(e.target.value))}
                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            ...
            <div>
              <label htmlFor="last_login_after" className="block text-sm font-medium text-gray-700 mb-1 md:text-base lg:text-lg">
                Last Login After
              </label>
              <input
                id="last_login_after"
                ...
                onChange={(e) = aria-label="Input"> handleFilterChange('last_login_after', parseDateFromInput(e.target.value))}
                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
            </div>

            <div>
              <label htmlFor="last_login_before" className="block text-sm font-medium text-gray-700 mb-1 md:text-base lg:text-lg">
                Last Login Before
              </label>
              <input
                ...
                onChange={(e) = aria-label="Input"> handleFilterChange('last_login_before', parseDateFromInput(e.target.value))}
                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </div>
        ...
        <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-gray-200">
          {localFilters.search && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 sm:text-sm md:text-base">
              ...
              <button
                onClick={() = aria-label="Button"> handleFilterChange('search', undefined)}
          ...
          {localFilters.role && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 sm:text-sm md:text-base">
              ...
              <button
                onClick={() = aria-label="Button"> handleFilterChange('role', undefined)}
          ...
          {localFilters.is_active !== undefined && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 sm:text-sm md:text-base">
              ...
              <button
                onClick={() = aria-label="Button"> handleFilterChange('is_active', undefined)}
          ...
          {localFilters.is_verified !== undefined && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 sm:text-sm md:text-base">
              ...
              <button
                onClick={() = aria-label="Button"> handleFilterChange('is_verified', undefined)}
