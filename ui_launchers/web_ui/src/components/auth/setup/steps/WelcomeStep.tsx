          ...
          <Card key={index} className="border-2 border-muted hover:border-primary/50 transition-colors">
            <CardContent className="p-4 text-center space-y-3 sm:p-4 md:p-6">
              <div className="flex justify-center">
                <feature.icon className="h-8 w-8 text-primary sm:w-auto md:w-full" />
              </div>
              <h3 className="font-semibold text-foreground">{feature.title}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed md:text-base lg:text-lg">
                {feature.description}
              </p>
            </CardContent>
          </Card>
      ...
      <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
        <CardContent className="p-4 sm:p-4 md:p-6">
          <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-3 flex items-center">
            <CheckCircle className="h-5 w-5 mr-2 sm:w-auto md:w-full" />
            What you'll need:
          </h3>
          <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200 md:text-base lg:text-lg">
            <li className="flex items-center">
              <CheckCircle className="h-4 w-4 mr-2 text-blue-600 sm:w-auto md:w-full" />
      ...
      <Card className="bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800">
        <CardContent className="p-4 sm:p-4 md:p-6">
          <h3 className="font-semibold text-amber-900 dark:text-amber-100 mb-2 flex items-center">
            <Shield className="h-5 w-5 mr-2 sm:w-auto md:w-full" />
            Security Notice
          </h3>
          <p className="text-sm text-amber-800 dark:text-amber-200 leading-relaxed md:text-base lg:text-lg">
      ...
      <div className="text-center pt-4">
        <button
         ...
         aria-label="Button">
          ...
          <ArrowRight className="ml-2 h-5 w-5 sm:w-auto md:w-full" />
        </Button>
      </div>
    </div>
  );
