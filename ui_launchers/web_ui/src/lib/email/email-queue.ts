      ...
      for (const recipient of operation.recipients) {
        if (recipient.status === 'pending') {
          const message: EmailMessage = {
            ...
            to: recipient.email,
            from: 'noreply@ai-karen.com', // This would come from config
            subject: 'Bulk Email', // This would come from template
            html_content: 'Bulk email content', // This would come from template
            text_content: 'Bulk email content', // This would come from template
