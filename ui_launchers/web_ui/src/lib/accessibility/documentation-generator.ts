...
export class AccessibilityDocumentationGenerator {
  ...
  async generateDocumentation(): Promise<void> {
    console.log('🔍 Analyzing components for accessibility features...');
    
    // Analyze components
    await this.analyzeComponents();
    
    console.log(`📝 Found ${this.componentRegistry.size} components to document`);
    ...
    console.log('✅ Accessibility documentation generated successfully!');
  }
