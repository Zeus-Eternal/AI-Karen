...
export default function ModelUploadManager({ 
  ...
  const handleConvertToGGUF = async () => {
    ...
    try {
      ...
      const info = handleError(toExtendedError(error), { operation: 'convertToGGUF' });
      toast({
        variant: 'destructive',
  ...
  const handleQuantizeModel = async () => {
    ...
    try {
      ...
      const info = handleError(toExtendedError(error), { operation: 'quantizeModel' });
      toast({
        variant: 'destructive',
  ...
  const handleMergeLoRA = async () => {
    ...
    try {
      ...
      const info = handleError(toExtendedError(error), { operation: 'mergeLoRA' });
      toast({
        variant: 'destructive',
