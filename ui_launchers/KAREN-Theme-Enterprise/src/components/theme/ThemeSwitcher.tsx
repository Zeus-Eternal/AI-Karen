...
import type { Density, Theme } from '@/providers/theme-context';
...
export const ThemeSwitcher = React.forwardRef<HTMLDivElement, ThemeSwitcherProps>(
  ({ className, showDensityControl = false, variant = 'buttons', size = 'md', ...props }, ref) => {
    const { theme, setTheme, density, setDensity, effectiveTheme, isSystemTheme } = useTheme();
    ...
    const isDensityValue = (value: string): value is Density =>
