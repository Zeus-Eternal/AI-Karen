...
import { handleAGUIError, FallbackStrategy, type FallbackResponse } from '../../lib/errorHandler';
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo): void {
    ...
    // Handle AG-UI errors using the consolidated error handler
    handleAGUIError(error, componentName)
  ...
  handleReset = () => {
    const componentName = this.props.componentName || 'unknown';
    // Component reset functionality removed as part of consolidation
    this.setState({
      hasError: false,
      error: null,
      errorInfo: null,
...
export function useErrorBoundary() {
  return {
    resetComponent: (componentName: string) => {
      // Component reset functionality now integrated into main error handler
    },
    getComponentHealth: (componentName: string) => {
      // Component health functionality now integrated into main error handler
      return {
        isHealthy: true,
        failureCount: 0,
