...
// Removed useResponsivePanel, usePanelBackdrop - using native Tailwind CSS utilities instead
...
const RightPanelBase = React.forwardRef<HTMLElement, RightPanelProps>(
  function RightPanel(
    ...
    // Removed legacy responsive panel hooks - now using native Tailwind CSS utilities
      ...
      <>
        ...
        <motion.aside
          ...
          className={cn(
            ...
            shouldOverlay && "sm:relative sm:right-auto sm:top-auto sm:z-auto sm:panel-viewport-height-desktop-auto",
            // Background and border with consistent design tokens
            "bg-background/95 backdrop-blur-md supports-[backdrop-filter]:bg-background/80",
            "border-l border-border/50",
            "shadow-xl",
            // Enhanced shadow on mobile for overlay effect
            shouldOverlay && "shadow-2xl sm:shadow-xl",
            ...
            widthClass,
            // Removed legacy responsive classes - now using native Tailwind CSS utilities
            // Responsive visibility
            shouldCollapse && "max-sm:translate-x-full max-sm:data-[state=open]:translate-x-0",
            className
          )}
          style={{
          ...
          data-state={isOpen ? "open" : "closed"}
          data-mobile-overlay={shouldOverlay}
          data-collapsible={shouldCollapse}
          // Touch gesture props
          // Removed legacy touch props - now using native Tailwind CSS utilities
          {...filteredProps}
        >
