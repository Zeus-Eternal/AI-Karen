...
export class AuthenticatedExtensionService {
  ...
  async getInstalledExtensions(): Promise<ExtensionInfo[]> {
    ...
    try {
      ...
      return this.handleServiceError(error as Error, context, []);
    }
  }
  ...
  async loadExtension(name: string): Promise<boolean> {
    ...
    try {
      ...
      return this.handleServiceError(error as Error, context, false);
    }
  }
  ...
  async registerBackgroundTask(taskData: {
    ...
    try {
      ...
      return this.handleServiceError(error as Error, context, null);
    }
  }
