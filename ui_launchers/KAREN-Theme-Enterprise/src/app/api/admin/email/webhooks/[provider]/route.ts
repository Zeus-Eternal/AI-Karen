      ...
      if (typeof eventDataRaw === "object" && eventDataRaw !== null) {
        ...
        const msgHeaders =
          typeof ed["message"] === "object" && ed["message"] !== null
            ? (ed["message"] as Record<string, unknown>).headers as Record<string, unknown> | undefined
            : undefined;
        return [
          {
            event_id: toStringOrUndefined(ed.id) ?? toStringOrUndefined((msgHeaders as Record<string, unknown>)?.["message-id"]),
