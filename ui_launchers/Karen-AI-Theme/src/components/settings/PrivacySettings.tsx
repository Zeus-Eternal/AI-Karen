        ...
        <Alert variant="default" className="bg-background border-border">
            ...
            <AlertDescription className="text-xs text-muted-foreground space-y-1">
                ...
                <ul className="list-disc list-inside pl-4">
                    <li><strong>API Keys (for convenience):</strong> Provider API keys (Gemini, OpenAI, Anthropic, Cohere) you enter in the "API Key" tab are saved here to pre-fill the fields. For the AI to function, these keys must also be configured server-side.</li>
                    ...
                    <li><strong>Plugin-Specific Settings:</strong> Configuration for plugins like the Weather service.</li>
                </ul>
                <p className="mt-2">
                  <strong>Your Control:</strong> You can modify or clear most of this data through the respective settings tabs. To remove all locally stored data for this application, you can clear your browser's site data for this website.
                </p>
            </AlertDescription>
        </Alert>
          ...
          <h3 className="text-sm font-medium text-foreground">Server-Side Data (Conceptual)</h3>
           <Alert variant="default" className="bg-muted/30">
            ...
            <AlertDescription className="text-muted-foreground text-xs">
              This application primarily uses data stored locally in your browser for settings and personalization. Any persistent storage of user accounts or extensive conversation histories on a server would be governed by the application's backend and its own privacy policy.
            </AlertDescription>
          </Alert>
        </div>
