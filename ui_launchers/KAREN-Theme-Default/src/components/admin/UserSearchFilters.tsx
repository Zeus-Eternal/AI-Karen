...
export function UserSearchFilters({
  ...
  const handleFilterChange = useCallback(
    (key: keyof UserListFilter, value: any, opts?: { immediate?: boolean }) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            <div>
              ...
              <Input
                id="created_after"
                type="date"
                value={formatDateForInput(localFilters.created_after as any)}
                onChange={(e) =>
            ...
            <div>
              ...
              <Input
                id="created_before"
                type="date"
                value={formatDateForInput(localFilters.created_before as any)}
                onChange={(e) =>
            ...
            <div>
              ...
              <Input
                id="last_login_after"
                type="date"
                value={formatDateForInput(localFilters.last_login_after as any)}
                onChange={(e) =>
            ...
            <div>
              ...
              <Input
                ...
                type="date"
                value={formatDateForInput(localFilters.last_login_before as any)}
                onChange={(e) =>
      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-gray-200">
          ...
          {(localFilters.created_after || localFilters.created_before) && (
            <Badge variant="secondary" className="px-3 py-1">
              Created: {formatDateForInput(localFilters.created_after as any)} →{" "}
              {formatDateForInput(localFilters.created_before as any)}
              <Button
                variant="ghost"
                className="h-6 px-1 ml-2"
                onClick={() => {
          ...
          {(localFilters.last_login_after || localFilters.last_login_before) && (
            <Badge variant="secondary" className="px-3 py-1">
              Last Login: {formatDateForInput(localFilters.last_login_after as any)} →{" "}
              {formatDateForInput(localFilters.last_login_before as any)}
              <Button
                variant="ghost"
                className="h-6 px-1 ml-2"
                onClick={() => {
