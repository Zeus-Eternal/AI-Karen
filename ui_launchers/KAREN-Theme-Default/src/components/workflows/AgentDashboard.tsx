                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex flex-col gap-2 ml-4">
                            {agent.status === 'stopped' || agent.status === 'idle' ? (
                              <Button
                                size="sm"
                                onClick={() => handleAgentAction('start', agent.id)}
...
function AgentDetailsPanel({ agent, onClose }: { agent: Agent, onClose: () => void }) {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <div className="mt-2 space-y-2 text-sm md:text-base lg:text-lg">
                <div className="flex justify-between">
                  ...
                  <span className="ml-2 font-medium">{agent.config.maxConcurrentTasks}</span>
                </div>
                <div className="flex justify-between">
                  <span>Timeout:</span>
                  <span className="ml-2 font-medium">{agent.config.timeout}ms</span>
                </div>
                <div className="flex justify-between">
                  <span>Retry Attempts:</span>
                  <span className="ml-2 font-medium">{agent.config.retryAttempts}</span>
                </div>
              </div>
            </div>
            <div>
