    ...
    <div className="p-6 space-y-6 sm:p-4 md:p-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <Button variant="outline" onClick={handleAutoOptimize}>Auto-optimize</Button>
          <Button variant="outline" onClick={handleClearCaches}>Clear Caches</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4 sm:p-4 md:p-6">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{metrics.overall.requestThroughput.toFixed(1)}</p>
        ...
        {/* Additional Metrics - Similar Cards for Avg Response Time, Error Rate, Uptime */}
        {/* ... similar card structures for other metrics */}
      </div>
