      ...
      for (const file of response.models || []) {
        try {
          ...
          const model: Model = {
            ...
            format: 'gguf',
            size: file.size,
            description: this.generateModelDescription(metadata, "text"),
      ...
      for (const modelDir of response.models || []) {
        try {
          ...
          const model: Model = {
            ...
            size: modelDir.size,
            description: this.generateModelDescription(metadata, modelType),
      ...
      for (const sdModel of response.models || []) {
        try {
          ...
          const model: Model = {
            ...
            size: sdModel.size,
            description: this.generateModelDescription(metadata, "image"),
