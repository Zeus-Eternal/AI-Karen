...
async def get_current_user(
    request: Request, user_context: Dict[str, Any] = Depends(get_current_chat_user)
) -> Dict[str, Any]:
    ...
    try:
        ...
        if request.metadata:
            ...
            new_metadata = (
                ...
                if hasattr(request.metadata, "dict")
...
async def send_message(
    ...
    try:
        ...
        message = await chat_service.send_message_secure(
            conversation_id, user_id, request
        )
