...
async def test_session_creation():
    ...
    try:
        ...
        from ai_karen_engine.core.dependencies import get_conversation_service, get_current_tenant_id, get_current_user_context
...
async def test_session_loading(session_id):
    ...
    try:
        from ai_karen_engine.api_routes.conversation_routes import get_conversation_by_session
        from ai_karen_engine.core.dependencies import get_conversation_service, get_current_tenant_id, get_current_user_context
...
async def test_message_sending(session_id):
    ...
    try:
        ...
        print(f"   - Content: {result.get('message', {}).get('content', 'N/A')[:100]}...")
