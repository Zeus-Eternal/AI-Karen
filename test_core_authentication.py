...
class TestCoreAuthenticator:
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_invalid_credentials(self, core_auth, sample_user_data):
    ...
    @pytest.mark.asyncio
    async def test_update_user_password_wrong_current(self, core_auth, sample_user_data):
    ...
    async def test_password_rehashing(self, core_auth, sample_user_data):
        ...
        # Get initial hash
        initial_hash = await core_auth.db_client.get_user_password_hash(created_user.user_id)
        ...
        updated_hash = await core_auth.db_client.get_user_password_hash(created_user.user_id)
