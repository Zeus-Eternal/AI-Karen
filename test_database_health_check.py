...
def test_basic_health_check():
    ...
    try:
        ...
        print(f"Basic health check result: {'✓ HEALTHY' if is_healthy else '✗ UNHEALTHY'}")
...
async def test_async_health_check():
    ...
    try:
        ...
        print(f"Async basic health check: {'✓ HEALTHY' if is_healthy else '✗ UNHEALTHY'}")
...
def test_tenant_specific_health_check():
    ...
    try:
        ...
        health_status = client.health_check_with_tenant_support(tenant_id=test_tenant_id)
...
async def test_async_tenant_health_check():
    ...
    try:
        ...
        health_status = await client.async_health_check_with_tenant_support(tenant_id=test_tenant_id)
...
def test_convenience_functions():
    ...
    try:
        ...
        print(f"Convenience comprehensive check: {'✓ HEALTHY' if health_status.is_healthy else '✗ UNHEALTHY'}")
        
        # Test startup health check function
        startup_status = startup_database_health_check()
        print(f"Convenience startup check: {'✓ HEALTHY' if startup_status.is_healthy else '✗ UNHEALTHY'}")
...
async def test_async_convenience_functions():
    ...
    try:
        ...
        print(f"Async convenience check: {'✓ HEALTHY' if health_status.is_healthy else '✗ UNHEALTHY'}")
...
def test_performance_metrics():
    ...
    try:
        ...
        for i in range(5):
            ...
            print(f"Check {i+1}: {response_time:.2f}ms - {'✓' if health_status.is_healthy else '✗'}")
...
async def main():
    ...
    test_results.append(("Comprehensive Health Check", test_comprehensive_health_check()))
    test_results.append(("Startup Health Check", test_startup_health_check()))
    test_results.append(("Tenant-Specific Health Check", test_tenant_specific_health_check()))
    ...
    test_results.append(("Async Tenant Health Check", await test_async_tenant_health_check()))
    test_results.append(("Async Convenience Functions", await test_async_convenience_functions()))
