...
from ai_karen_engine.database.client import db_client, create_database_tables
...
async def main():
    ...
    if not check_database_connection():
        print("❌ Cannot connect to database. Please check your DATABASE_URL configuration.")
        sys.exit(1)
