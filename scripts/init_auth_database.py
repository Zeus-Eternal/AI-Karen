...
def run_sql_migration():
    ...
    if not database_url:
        ...
        print("   Please set one of these variables to your PostgreSQL connection string")
    ...
    sql_file = script_dir.parent / "data" / "migrations" / "postgres" / "001_create_auth_tables.sql"
