...
try:
    ...
    def semantic_search_df(*_, **__):
        raise NotImplementedError("semantic_search_df not available.")

    def summarize_dataframe(*_, **__):
        raise NotImplementedError("summarize_dataframe not available.")
