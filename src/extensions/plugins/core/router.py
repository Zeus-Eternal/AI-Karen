...
try:
    ...
    jinja_env = Environment(
        loader=FileSystemLoader(str(Path(__file__).parent.parent.parent.parent.parent / "plugins")),
...
# --- Paths & schema -----------------------------------------------------
# Plugin root defaults to the implementations directory but may be overridden
...
# exists.
DEFAULT_PLUGIN_ROOT = Path(__file__).parent.parent / "implementations"
PLUGIN_ROOT = Path(os.getenv("KARI_PLUGIN_DIR", DEFAULT_PLUGIN_ROOT))
PLUGIN_META = "__meta"
PLUGIN_MANIFEST = "plugin_manifest.json"
PROMPT_FILE = "prompt.txt"
HANDLER_FILE = "handler.py"
SCHEMA_PATH = Path(__file__).parents[4] / "config" / "plugin_schema.json"
