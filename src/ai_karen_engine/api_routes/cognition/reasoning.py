...
async def execute_reasoning_query(
    ...
    **RBAC:** Requires `reasoning:query` scope
    ...
    try:
        ...
        # Execute Reasoning
        trace = await ice_wrapper.aprocess(
            text=request.query,
            metadata={
                "top_k": request.top_k,
        ...
        logger.info(
            ...
            retrieved_count=len(trace.memory_matches),
            confidence=trace.confidence_estimate,
        )
        ...
        return ReasoningResult(
            ...
            retrieved_knowledge=trace.memory_matches,
            reasoning_trace=trace.to_dict() if request.include_trace else None,
            confidence=trace.confidence_estimate,
            strategy_used=trace.recall_strategy_used,
