...
async def get_chat_context(
    ...
    max_turns: Optional[int] = Query(None, ge=1, le=100, description="Maximum turns to return"),
    current_user: Dict[str, Any] = Depends(get_current_user)
):
    ...
    try:
        ...
        return {
            ...
            "stats": {
                ...
                "last_summarized_at": chat_config.last_summarized_at.isoformat() if chat_config.last_summarized_at else None,
