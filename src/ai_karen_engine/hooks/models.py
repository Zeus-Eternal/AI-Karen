...
class HookResult:
    ...
    @classmethod
    def success_result(cls, hook_id: str, result: Any, execution_time_ms: float = 0.0) -> HookResult:
    ...
    @classmethod
    def error_result(cls, hook_id: str, error: str, execution_time_ms: float = 0.0) -> HookResult:
