...
from .models import HookContext, HookResult, HookExecutionSummary
...
class HookMixin:
    ...
    async def register_hook(
        ...
        if not self.are_hooks_enabled():
            self._hook_logger.debug(f"Hooks disabled, skipping registration of {hook_type}")
            return None
    ...
    def get_hook_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            registered_hooks = self.hook_manager.get_hooks_by_source(source_type, source_name)
