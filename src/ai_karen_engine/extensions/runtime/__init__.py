...
Contains engine-facing runtime behavior for extensions including:
- loader: Extension loading logic
- executor: Extension execution logic
- auth: Runtime authentication and authorization
- permissions: Runtime permissions enforcement
- config: Runtime configuration management
- lifecycle: Runtime lifecycle management
- health_monitor: Extension health monitoring
