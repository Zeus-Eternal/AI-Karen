...
class ResponseFormattingIntegration:
    ...
    def __init__(self):
        ...
        self.monitor.update_active_formatters_count(
            len(self.get_available_formatters())
        )
    ...
    async def format_response(
        ...
        try:
            ...
            # Format the response
            formatted_response = self.registry.format_response(
            ...
            formatted_response.metadata.update(
                {
                    ...
                    "formatting_integration": {
                        "version": "1.0.0",
                        "formatter_used": formatted_response.metadata.get(
                            "formatter", "unknown"
                        ),
    ...
    async def detect_content_type(
        self, user_query: str, response_content: str
        ...
        """
        return await self.content_detector.detect_content_type(
            user_query, response_content
        )
    ...
    async def validate_integration(self) -> Dict[str, Any]:
        ...
        validation_results["overall_healthy"] = (
            validation_results["registry_healthy"]
            and validation_results["detector_healthy"]
