...
import { WebSearchOptions } from '../types';

interface ModeSpecificControlsProps {
  modeConfig: ModeConfigItem;
  options: WebSearchOptions;
  onOptionsChange: (options: Partial<WebSearchOptions>) => void;
  disabled?: boolean;
}
...
export function ModeSpecificControls({ modeConfig, options, onOptionsChange, disabled }: ModeSpecificControlsProps) {
  ...
  const renderInput = (field: keyof WebSearchOptions, label: string, type: string = 'text', placeholder?: string) => {
