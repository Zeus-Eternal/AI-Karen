...
class StockMarketHandler(BaseWebSearchModeHandler):
    """
    ...
    async def prepare(
        ...
        response = {
            ...
            "market_profile": {
                ...
                "company_name": self._normalize_string(
                    safe_context.get("company_name")
                ),
            ...
            "time_policy": {
                ...
                "market_session": self._normalize_string(
                    safe_context.get("market_session")
                ),
            },
            "domain_policy": {
