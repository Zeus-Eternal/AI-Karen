...
def __getattr__(name: str):
    if name == "ExtensionCoreManager":
        return import_module(
            "ai_karen_engine.extensions.platform.core.manager"
        ).ExtensionCoreManager
