...
class AuthService(BaseService):
    ...
    def _is_rate_limited(self, ip_address: str, email: str) -> bool:
        ...
        # Count recent attempts for this specific IP/email combination
        recent_attempts = [
    ...
    def _record_auth_attempt(self, ip_address: str, email: str, success: bool, user_agent: Optional[str] = None) -> None:
    ...
    async def authenticate_user(self, email: str, password: str, ip_address: str, user_agent: Optional[str] = None) -> Tuple[Optional[UserAccount], Optional[str], Optional[str]]:
        """
    ...
    async def create_user(self, email: str, password: str, full_name: str, roles: Optional[List[str]] = None) -> Tuple[Optional[UserAccount], Optional[str]]:
        """
