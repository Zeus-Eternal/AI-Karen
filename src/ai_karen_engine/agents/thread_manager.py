...
try:
    from ai_karen_engine.session_state.langgraph_integration import LangGraphIntegration
    HAS_LANGGRAPH = True
except ImportError:
    HAS_LANGGRAPH = False
...
try:
    from ai_karen_engine.session_state.session_state_manager import SessionStateManager
    from ai_karen_engine.session_state.session_state_models import SessionState
...
class ThreadManager(BaseService, ThreadManagerInterface):
    ...
    async def create_thread(self, request: CreateThreadRequest) -> CreateThreadResponse:
        ...
        try:
            ...
            if self._session_state_manager and SessionState:
                try:
                    from ai_karen_engine.session_state.session_state_models import CreateSessionStateRequest
    ...
    async def get_thread(self, request: GetThreadRequest) -> GetThreadResponse:
        ...
        try:
            async with self._lock:
                ...
                if self._session_state_manager:
                    try:
                        from ai_karen_engine.session_state.session_state_models import GetSessionStateRequest
    ...
    async def update_thread(self, request: UpdateThreadRequest) -> UpdateThreadResponse:
        ...
        try:
            ...
            async with self._lock:
                ...
                if self._session_state_manager:
                    try:
                        from ai_karen_engine.session_state.session_state_models import UpdateSessionStateRequest
    ...
    async def _delete_thread_internal(self, thread_id: str, hard_delete: bool = False) -> bool:
        ...
        async with self._lock:
            ...
            if hard_delete:
                ...
                if self._session_state_manager:
                    try:
                        from ai_karen_engine.session_state.session_state_models import DeleteSessionStateRequest
    ...
    async def create_checkpoint(self, session_id: str, thread_id: str, checkpoint_data: Dict[str, Any]) -> bool:
        ...
        try:
            from ai_karen_engine.session_state.session_state_models import CreateCheckpointRequest
    ...
    async def restore_from_checkpoint(self, session_id: str, checkpoint_id: str) -> bool:
        ...
        try:
            from ai_karen_engine.session_state.session_state_models import RestoreFromCheckpointRequest
