...
from ai_karen_engine.services.ai_orchestrator.ai_orchestrator import FlowType, FlowInput, FlowOutput
...
class AgentOrchestrator(BaseService):
    ...
    async def _discover_service(self, service_name: str) -> Optional[Any]:
        ...
        try:
            if service_name == "ai_orchestrator":
                ...
                try:
                    from ai_karen_engine.services.model_orchestrator_service import ModelOrchestratorService
    ...
    async def _process_task_with_agent(self, task: agent_schemas.AgentTask, agent_instance: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._ai_orchestrator:
                from ai_karen_engine.services.ai_orchestrator.ai_orchestrator import FlowInput
    ...
    async def retrieve_agent_memory(
        ...
        try:
            ...
            if not memories and self._memory_service:
                try:
                    from ai_karen_engine.memory.unified_memory_service import MemoryQueryRequest
