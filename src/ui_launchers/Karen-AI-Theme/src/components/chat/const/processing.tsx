...
export const PROCESSING_STATE_LABELS: Record<ChatProcessingState, string> = {
  idle: "Ready",
  queued: "Queued",
  preparing: "Understanding request...",
  authenticating: "Checking access",
  context: "Checking whether tools are needed...",
  cortex: "Checking memory relevance...",
  retrieving_memory: "Recalling recent context...",
  routing: "Searching saved facts...",
