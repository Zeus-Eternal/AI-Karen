...
from src.services.copilot_capabilities import (
    CopilotCapability,
...
from src.services.tools.contracts import (
    ToolScope,
    RBACLevel,
    PrivacyLevel,
    ToolContext,
...
from src.services.tools.copilot_tools import COPILOT_TOOLS
from src.services.tools.registry import (
    CopilotToolRegistry,
